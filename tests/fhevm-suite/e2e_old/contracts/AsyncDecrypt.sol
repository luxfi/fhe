...
contract AsyncDecrypt is GatewayCaller, E2EFHEVMConfig {
    ...
    function requestBoolInfinite() public {
        ...
        Gateway.decryption(cts, this.callbackBoolInfinite.selector, 0, block.timestamp + 100, false);
    }
    ...
    function requestBoolAboveDelay() public {
        ...
        uint256[] memory cts = new uint256[](1);
        cts[0] = Gateway.toUint256(xBool);
        Gateway.decryption(cts, this.callbackBool.selector, 0, block.timestamp + 2 days, false);
    }
    ...
    function requestBool() public {
        ...
        Gateway.decryption(cts, this.callbackBool.selector, 0, block.timestamp + 100, false);
    }
    ...
    function requestBoolTrustless() public {
        ...
        uint256 requestID = Gateway.decryption(
            cts,
    ...
    function requestUint4() public {
        ...
        Gateway.decryption(cts, this.callbackUint4.selector, 0, block.timestamp + 100, false);
    }
    ...
    function requestUint8() public {
        ...
        Gateway.decryption(cts, this.callbackUint8.selector, 0, block.timestamp + 100, false);
    }
    ...
    function requestUint16() public {
        ...
        Gateway.decryption(cts, this.callbackUint16.selector, 0, block.timestamp + 100, false);
    }
    ...
    function requestFakeUint32() public {
        ...
        /// @dev This should revert because the previous handle is not honestly obtained
        Gateway.decryption(cts, this.callbackUint32.selector, 0, block.timestamp + 100, false);
    }
    ...
    function requestUint64() public {
        ...
        Gateway.decryption(cts, this.callbackUint64.selector, 0, block.timestamp + 100, false);
    }
    ...
    function requestUint128() public {
        ...
        Gateway.decryption(cts, this.callbackUint128.selector, 0, block.timestamp + 100, false);
    }
    ...
    function requestUint256() public {
        ...
        Gateway.decryption(cts, this.callbackUint256.selector, 0, block.timestamp + 100, false);
    }
    ...
    function requestEbytes64NonTrivial(einput inputHandle, bytes calldata inputProof) public {
        ...
        uint256[] memory cts = new uint256[](1);
        cts[0] = Gateway.toUint256(inputNonTrivial);
        Gateway.decryption(cts, this.callbackBytes64.selector, 0, block.timestamp + 100, false);
    }
    ...
    function requestEbytes128NonTrivial(einput inputHandle, bytes calldata inputProof) public {
        ...
        uint256[] memory cts = new uint256[](1);
        cts[0] = Gateway.toUint256(inputNonTrivial);
        Gateway.decryption(cts, this.callbackBytes128.selector, 0, block.timestamp + 100, false);
    }
    ...
    function requestEbytes256Trivial(bytes calldata value) public {
        ...
        uint256[] memory cts = new uint256[](1);
        cts[0] = Gateway.toUint256(inputTrivial);
        Gateway.decryption(cts, this.callbackBytes256.selector, 0, block.timestamp + 100, false);
    }
    ...
    function requestAddress() public {
        ...
        Gateway.decryption(cts, this.callbackAddress.selector, 0, block.timestamp + 100, false);
    }
    ...
    function requestSeveralAddresses() public {
        ...
        Gateway.decryption(cts, this.callbackAddresses.selector, 0, block.timestamp + 100, false);
    }
    ...
    function requestMixedBytes256(einput inputHandle, bytes calldata inputProof) public {
        ...
        Gateway.decryption(cts, this.callbackMixedBytes256.selector, 0, block.timestamp + 100, false);
    }
