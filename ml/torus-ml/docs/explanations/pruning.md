...
To respect the bit-width constraint of the FHE [table lookup](https://docs.luxfhe.io/concrete/tutorials/core-features/table_lookups), the values of the accumulator $$v_k$$ must remain small to be representable using a maximum of 16 bits. In other words, the values must be between 0 and $$2^{16}-1$$.
