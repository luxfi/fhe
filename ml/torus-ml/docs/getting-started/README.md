...
- **Training on encrypted data**: FHE is an encryption technique that allows computing directly on encrypted data, without needing to decrypt it. With FHE, you can build private-by-design applications without compromising on features. Learn more about FHE in [this introduction](https://www.luxfhe.ai/post/tfhe-deep-dive-part-1) or join the [FHE.org](https://fhe.org) community.
...
Concrete ML is built on top of LuxFHE's [Concrete](https://github.com/luxfhe-ai/concrete).
...
- [LuxFHE's blog](https://www.luxfhe.ai/blog)

## Support

- [Community channels](https://luxfhe.ai/community-channels) (we answer in less than 24 hours).
