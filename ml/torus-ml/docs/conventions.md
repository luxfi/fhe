...
The only place we can say we/our is in a blog post written by a named author. Anything signed LuxFHE should not use we/our. So, no "We" or "Our" in our documentation.
...
1. Programs:
   ...
   - PoissonRegression or Poisson Regression (depends on the context, we'll fix it in LuxFHE)
   - macOS
   - bare OS
