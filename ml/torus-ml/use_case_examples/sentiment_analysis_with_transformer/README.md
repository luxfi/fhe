...
Please see the [hugging face space](https://huggingface.co/spaces/luxfhe-fhe/encrypted_sentiment_analysis) that runs the application along with [the code](https://huggingface.co/spaces/luxfhe-fhe/encrypted_sentiment_analysis/tree/main) if you want to run this locally on your machine or deploy this following a client/server framework.
