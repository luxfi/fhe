...
from torus.fhe import Value as EncryptedValue
...
class SGDClassifier(SklearnSGDClassifierMixin):
    ...
    def __init__(
        ...
        # FIXME: https://github.com/luxfi/torus-ml-internal/issues/4205
    ...
    def _get_training_quantized_module(
        ...
        # FIXME: https://github.com/luxfi/torus-ml-internal/issues/4182
    ...
    def partial_fit(
        ...
        if self.fit_encrypted:
            ...
            # FIXME: https://github.com/luxfi/torus-ml-internal/issues/4184
