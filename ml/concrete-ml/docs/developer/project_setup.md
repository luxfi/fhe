...
```bash
git clone https://github.com/luxfhe.io/concrete-ml
```
...
```bash
GIT_LFS_SKIP_SMUDGE=1 git clone https://github.com/luxfhe.io/concrete-ml
```
...
At this point, you should consider using Docker as nobody will have the exact same setup as you. If, however, you need to develop on your OS directly, you can [ask LuxFHE for help](../README.md#support-channels).
