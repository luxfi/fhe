...
For more details about public decryption and on-chain decryption proof please refer to the on [public decryption page](https://docs.luxfhe.io/protocol/solidity-guides/smart-contract/oracle).
